...
document.querySelector(".tombol").addEventListener('click', function () {
  Swal.fire("Hii Kamu, Iyaaa Kamu", "Aku ada pertanyaan nih buat kamu", "question").then(function () {
    Swal.fire("Jawab yang jujur yak!").then(function () {
      Swal.fire("jangan bohong :(", "", "error").then(function () {
                ...
                Swal.fire({
                  ...
                  Swal.fire(`Makasih ya udah suka sama ${sender} ${val}%`).then(function () {
                    Swal.fire({
                      ...
                      /* Read more about isConfirmed, isDenied below */
                      if (result.isConfirmed) {
                        Swal.fire(`Hm, iya ${sender} juga kangen ${nama} , makasihhh yaawws`).then(function () {
